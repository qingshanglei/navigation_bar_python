...
### 2.4 获取子分类列表
**基本信息**
- **请求路径**: `/api/categories/{id}/children`
- **请求方式**: GET
- **接口描述**: 获取指定分类的直接子分类
...
const getCategoriesList = async () => {
    const response = await fetch('/api/categories?page=1&size=20', {
        headers: {
